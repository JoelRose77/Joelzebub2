...
sr.reveal('.animated-text',{delay:2500, origin:'right'});
// sr.reveal('#sliderValue',{delay:3500, origin:'top'});
// sr.reveal('.animation',{delay:5500, origin:'top'});
sr.reveal('.start',{delay:5500, origin:'bottom'});


sr.reveal('.about-text',{delay:2000, origin:'right'});
sr.reveal('.about-img',{delay:500, origin:'left'});

sr.reveal('.animated',{delay:900, origin:'top'});

sr.reveal('.h3-mktg',{delay:900, origin:'right'});
sr.reveal('.about-hobbies',{delay:3000, origin:'bottom'});
sr.reveal('.skillbar',{delay:5000, origin:'left'});
